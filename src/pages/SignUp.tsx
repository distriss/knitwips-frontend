        ...
        <>
          ...
          <section className="flex justify-center items-center bg-main2 px-40 py-10">
              <div className="max-w-sm w-full lg:max-w-7xl lg:flex">
                  <div title="Knitting Project" 
                    className="signup-img h-48 lg:h-auto lg:w-1/2 flex-none bg-cover rounded-t lg:rounded-tr-none lg:rounded-l text-center overflow-hidden"  >
