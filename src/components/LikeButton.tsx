...
export default function LikeButton({ id, likesCount, authUserLiked, onLike }: LikeButtonProps) {
    ...
    return (
        <>
          { authUser ? ( 
            <div className="flex flex-col items-start justify-between mb-4 text-accent2 z-50 float-right">  
                <button 
                    onClick={handleLike} 
                    key={id}
                ...
                <span className="text-primary1 m-2 text-nowrap">{likesCount} Likes</span> 
                <div className="mb-4">
